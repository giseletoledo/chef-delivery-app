...
//  ChefDelivery
//
//  Created by GISELE TOLEDO on 11/07/23.
//
...
let storesMock: [StoreType] = [
    StoreType(
        id: 1,
        name: "Monstro Burger",
        logoImage: "monstro-burguer-logo",
        headerImage: "monstro-burguer-header",
        location: "Rua Principal, 123, São Paulo, SP",
        stars: 4,
        products: [
            ProductType(id: 1, name: "Hambúrguer Clássico", description: "Hambúrguer de carne com queijo, alface e tomate", image: "classic_burguer", price: 14.99),
            ProductType(id: 2, name: "Hambúrguer com Bacon", description: "Hambúrguer de carne com queijo, bacon crocante, alface e tomate", image: "bacon_burguer", price: 16.99),
